...
(1, "Big Ben", "London, UK", 51.5007, -0.1246, "Famous Towers and Structures", "One of London's most recognizable landmarks, Big Ben is the clock tower attached to the Houses of Parliament. It is a symbol of British democracy and a masterpiece of 19th-century engineering."),
...
(7, "The Shard", "London, UK", 51.5045, -0.0865, "Famous Towers and Structures", "Standing as the tallest building in the UK, The Shard offers breathtaking panoramic views of London from its observation deck. Its sleek glass design contrasts with the city's historic skyline."),
...
(15, "Tower Bridge", "London, UK", 51.5055, -0.0754, "Famous Towers and Structures", "One of London's most famous bridges, Tower Bridge is a bascule and suspension bridge that lifts to allow ships to pass through. Visitors can walk across the high-level glass floor walkway for stunning Thames views."),
(16, "The Gherkin", "London, UK", 51.5144, -0.0803, "Famous Towers and Structures", "A modern skyscraper in London's financial district, The Gherkin is known for its unique, curved glass structure. It is an architectural icon of the city’s skyline."),
